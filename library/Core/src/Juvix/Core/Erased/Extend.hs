...
extValue :: p1 -> p2 -> IR.ExtValue
extValue _ _ = IR.defaultExtValue

extNeutral :: p1 -> p2 -> IR.ExtNeutral
extNeutral _ _ = IR.defaultExtNeutral

extPattern :: p1 -> p2 -> IR.ExtPattern
extPattern _ _ = IR.defaultExtPattern
