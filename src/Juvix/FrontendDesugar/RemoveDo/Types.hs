...
extendExpression "Expression" [] [t|T|] defaultExtExpression {typeCond = Nothing, typeDo = Nothing, typeInfix = Nothing}
...
extendNameSet "NameSet" [] [t|T|] $ const defaultExtNameSet {typeNonPunned = Nothing}
