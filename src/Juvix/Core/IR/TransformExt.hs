...
pattern ExtTransformTE { etStar, etPrimTy, etPi, etLam, etElim, etBound,
                         etFree, etPrim, etApp, etAnn, etTermX, etElimX } =
  ExtTransformTEF {
...
extTransformT :: ExtTransformTE ext1 ext2 primTy primVal
              -> Term' ext1 primTy primVal -> Term' ext2 primTy primVal
...
extTransformE :: ExtTransformTE ext1 ext2 primTy primVal
              -> Elim' ext1 primTy primVal -> Elim' ext2 primTy primVal
...
extForgetT :: (TermX ext primTy primVal ~ Void,
               ElimX ext primTy primVal ~ Void)
           => Term' ext primTy primVal -> Term primTy primVal
extForgetT = extTransformT forgetter

extForgetE :: (TermX ext primTy primVal ~ Void,
               ElimX ext primTy primVal ~ Void)
           => Elim' ext primTy primVal -> Elim primTy primVal
