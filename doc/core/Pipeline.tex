...
\node[main] (4) [below of=3] {S-expression Desugared}; 
\node[main] (5) [below of=4] {Core HR}; 
\node[main] (6) [below of=5] {Core IR}; 
% TODO: From here, it's already type checked. Make it explicit
\node[main] (7) [below of=6] {Core Erased};  
\node[main] (8) [below of=7] {Backend}; 
...
\draw[->] (2) -- node[midway, right] {\href{https://github.com/heliaxdev/juvix/blob/develop/library/Translate/src/Juvix/Desugar.hs}{Translate: Juvix.FrontendDesugar.hs (op)}} (3); 
\draw[->] (3) -- node[midway, right] {\href{https://github.com/heliaxdev/juvix/blob/develop/library/Translate/src/Juvix/Contextify.hs}{Translate: Juvix.Contextify.hs (op)}} (4); 
\draw[->] (4) -- node[midway, right] {\href{https://github.com/heliaxdev/juvix/blob/develop/library/Translate/src/Juvix/ToCore/FromFrontend.hs}{Translate: Juvix.ToCore.FromFrontend.hs}} (5); 
\draw[->] (5) -- node[midway, right] {\href{https://github.com/heliaxdev/juvix/blob/develop/library/Core/src/Juvix/Core/Translate.hs}{Core: Juvix.Core.Translate.hs (hrToIR)}} (6); 
\draw[->] (6) -- node[midway, right] {\href{https://github.com/heliaxdev/juvix/blob/develop/library/Core/src/Juvix/Core/Erased/Ann/Conversion.hs}{Core: Juvix.Core.Erased.Ann.Conversion.hs (irToErasedAnn)}} (7);
\draw[->] (7) -- node[midway, right] {\href{}{To Backend}} (8);
\node[draw,dotted,fit=(3) (4), label={[xshift=0mm]left:{S-expressions}}] {};
\node[draw,dotted,fit=(5) (6), label={[xshift=0mm]left:{Extend from Core.Base}}] {};
\node[draw,dotted,fit=(7) , label={[xshift=0mm]left:{Typechecked}}] {};
