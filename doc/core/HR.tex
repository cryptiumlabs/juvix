...
\node[main] (9) [below of=8] {Core Type Checked}; 
\node[main] (10) [below of=9] {Core IR NoExt}; 
\node[main] (11) [below of=10] {Core Erased}; 
\node[main] (12) [below of=11] {Erased Term ???}; 
...
\draw[->] (7) -- node[midway, right] {\href{https://github.com/heliaxdev/juvix/blob/develop/library/Core/src/Juvix/Core/Translate.hs}{Core: Juvix.Core.Translate.hs}} (8); 
\draw[->] (8) -- node[midway, right] {\href{https://github.com/heliaxdev/juvix/blob/develop/library/Core/src/Juvix/Core/Translate.hs}{Core: Typecheck}} (9);
...
\draw[->] (10) -- node[midway, right] {\href{https://github.com/heliaxdev/juvix/blob/develop/library/Core/src/Juvix/Core/Translate.hs}{Core: Juvix.Core.Erasure.hs (erase)}} (11);
