...
% \node[main] (9) [below of=8] {Core Typed Term}; 
% \node[main] (10) [below of=9] {Core IR NoExt}; 
% TODO: From here, it's already type checked
\node[main] (11) [below of=8] {Core Erased}; 
\node[main] (12) [below of=11] {Erased Ann Term}; 
\node[main] (13) [below of=12] {Erased Term No Return}; 
...
\draw[->] (2) -- node[midway, right] {\href{https://github.com/heliaxdev/juvix/blob/develop/library/Translate/src/Juvix/ToCore/FromFrontend.hs}{???}} (3); 
\draw[->] (3) -- node[midway, right] {\href{https://github.com/heliaxdev/juvix/blob/develop/library/Translate/src/Juvix/ToCore/FromFrontend.hs}{Translate: Juvix.Desugar.hs (op)}} (4); 
\draw[->] (4) -- node[midway, right] {\href{https://github.com/heliaxdev/juvix/blob/develop/library/Translate/src/Juvix/ToCore/FromFrontend.hs}{Translate: Juvix.Contextify.hs (contextify)}} (5); 
\draw[->] (5) -- node[midway, right] {\href{https://github.com/heliaxdev/juvix/blob/develop/library/Translate/src/Juvix/ToCore/FromFrontend.hs}{???}} (6); 
...
% \draw[->] (8) -- node[midway, right] {\href{https://github.com/heliaxdev/juvix/blob/develop/library/Core/src/Juvix/Core/Translate.hs}{Core: Juvix.Core.IR.Typechecker.hs (typeCheckDeclaration)}} (9);
% \draw[->] (9) -- node[midway, right] {\href{https://github.com/heliaxdev/juvix/blob/develop/library/Core/src/Juvix/Core/Translate.hs}{Core: Juvix.Core.CoreToAnn.hs (eval)}} (10);
\draw[->] (8) -- node[midway, right] {\href{https://github.com/heliaxdev/juvix/blob/develop/library/Core/src/Juvix/Core/Translate.hs}{Core: Juvix.Core.Erasure.hs (erase)}} (11);
\draw[->] (11) -- node[midway, right] {\href{https://github.com/heliaxdev/juvix/blob/develop/library/Core/src/Juvix/Core/Translate.hs}{Core: Juvix.Core.ErasedAnn.Conversion.hs (convertTerm)}} (12);
\draw[->] (12) -- node[midway, right] {\href{https://github.com/heliaxdev/juvix/blob/develop/library/Core/src/Juvix/Core/Translate.hs}{Core: Juvix.Core.Pipeline.hs (toRaw)}} (13);
\draw[->] (13) -- node[midway, right] {\href{https://github.com/heliaxdev/juvix/blob/develop/library/Core/src/Juvix/Core/Translate.hs}{To Backend}} (14);
\node[draw,dotted,fit=(3) (4) (5) (6)] {};
\node[draw,dotted,fit=(7) (8)] {};
\node[draw,dotted,fit=(11) (12) (13)] {};
...
% \subsection{Why does it exist?}
% \subsection{Where is it placed in the pipeline?}
...
% \subsection{How is the code in there?}

HR stands for Human Readable.

% TODO: Point to a De Bruijn indices page
...
\begin{enumerate}
    ...
    % TODO: The usage in Pi is about how many times the arguments is used
...
% The goal of HRAnn is to extend HR terms with annotations. Annotations come in three flavors:
% \begin{enumerate}
%   \item Annotations
%   These are only applied to Elim
%   \item Bind Annotations

%   \item Let Annotations
%   \item App Annotations
%   We annotate its two arguments: functions and arguments
% \end{enumerate}

% We extend only Lambda, Pi, Sigma, Let and Elim. Why?

\section{Erased}

% Erased and HRAnn are deeply related.
